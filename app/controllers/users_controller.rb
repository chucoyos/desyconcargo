class UsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to @user, notice: t("users.create.success"), status: :see_other }
  ...
  def update
    ...
    respond_to do |format|
      if @user.update(user_params)
        format.html { redirect_to @user, notice: t("users.update.success"), status: :see_other }
  ...
  private
    ...
    def user_params
      user_params = params.require(:user).permit(:email, :password, :password_confirmation, :role_id)

      # Remove password parameters if they're blank to avoid clearing passwords
